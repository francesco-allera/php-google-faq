...
$imgProPic = "./img/profile-picture.png";
$imgLang = "./img/lang.png";
...
$nav = [
    ...
    [
        "section" => "Norme sulla privacy",
        "link" => "https://policies.google.com/privacy"
    ],
    [
        "section" => "Termini di servizio",
...
$faqs = [
    ...
    [
        "research" => "Stabilire il paese associato al tuo account",
        "answers" => [
    ...
    <div id="app">
            ...
            <nav>
                <div class="nav-top">
                    <div class="nav-top-left">
                        <img id="logo" src="<?php echo $imgLogo; ?>" alt="">

                        <span class="terms">Privacy e termini</span>
                    </div>
                    ...
                    <div class="nav-top-right">
                        ...
                        <img id="pro-pic" src="<?php echo $imgProPic; ?>" alt="">
                    </div>
                </div>

                <div class="nav-btm">
                    <?php foreach($nav as $key1 => $value1) { ?>
                        <div class="nav-btm-item">
                            <a href="<?php echo $value1['link']; ?>">
                                <?php echo $value1['section']; ?>
                            </a>
                        </div>
                    <?php } ?>
                </div>
        ...
        <footer>
            <div class="container">
                ...
                <div class="right">
                    <img id="lang" src="<?php echo $imgLang; ?>" alt="">
